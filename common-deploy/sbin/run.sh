#!/bin/bash
#author: wsh
PROJECT_MAIN=org.wsh.common.provider.dubbo.ProviderService
...
nohup java $JAVA_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS $PROJECT_MAIN > $STDOUT_FILE 2>&1 &
