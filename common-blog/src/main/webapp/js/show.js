        ...
        success:function(data){
            if(data.success){
                ...
                for (var i= 0; i < obj.length; i++) {
                    ...
                    $(".image-list").append("<div class=\"col-xs-6 col-sm-4 col-md-3 portfolio-item " + classz + " isotope-item " +  obj[i].tagsId + "\" style=\"position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);\">" +
                    ...
                    "<li><a href=\"" + obj[i].filePath + "\" data-lightbox=\"example-set\"><i class=\"fa fa-eye\"></i></a></li>" +
                    "</ul>" +
                    "</div>" +
                    "</div>" +
