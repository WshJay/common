...
public class Mybatisorm {
	...
	private static List<TableWapper> getTables() throws Exception {
		...
		builder.setPojoPackage("org.wsh.common.model.follow");//pojo包地址
		builder.setDaoPackage("org.wsh.common.dao.follow");//dao包地址
		builder.setServicePackage("org.wsh.common.service.api.follow");
		builder.setServiceImplPackage("org.wsh.common.service.impl.follow");
		builder.setServiceTestPackage("org.wsh.common.test.service.follow");
