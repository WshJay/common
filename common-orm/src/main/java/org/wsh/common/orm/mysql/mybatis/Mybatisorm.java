...
public class Mybatisorm {
	...
	private static List<TableWapper> getTables() throws Exception {
		...
		builder.setUrl("jdbc:mysql://47.88.25.246:3306/blog");//数据库链接
		builder.setName("root");//数据库用户名
		builder.setPwd("wsh0704");//数据库密码
		builder.setPojoPackage("org.wsh.common.model.blog");//pojo包地址
		builder.setDaoPackage("org.wsh.common.dao.blog");//dao包地址
		builder.setServicePackage("org.wsh.common.service.api.blog");
		builder.setServiceImplPackage("org.wsh.common.service.impl.blog");
		builder.setServiceTestPackage("org.wsh.common.test.service.blog");
