...
public class TicketTradeOper{
	...
	// 业务操作
	TjAppStartupDao tjAppStartupDao;
	...
	public TjAppStartupDao getTjAppStartupDao() {
		return tjAppStartupDao;
	}

	public void setTjAppStartupDao(TjAppStartupDao tjAppStartupDao) {
		this.tjAppStartupDao = tjAppStartupDao;
	}
