...
import com.xxx.common.util.properties.PropertiesUtils;
...
public class ConstantsUtil {
	...
	/** APP请求URL */
	public static String SERVER_HOST = PropertiesUtils.readProperties(PROPERTISE_PATH).getProperty("server.host");
